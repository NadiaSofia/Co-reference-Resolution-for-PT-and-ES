...
BATCH_SIZE_PATH = os.path.join(PACKAGE_DIRECTORY, "test_batch_size.txt")

SIZE_SPAN = 1500  # size of the span vector (averaged word embeddings)
SIZE_WORD = 8  # number of words in a mention (tuned embeddings)
SIZE_SPAN_BERT = 1024   # size of the bert span vector (averaged word embeddings) - 512 * 5
...
SIZE_MENTION_EMBEDDING = (SIZE_SPAN + SIZE_WORD * SIZE_EMBEDDING + SIZE_SPAN_BERT)  # A mention embeddings (span + words vectors)
